...
/* package */ class DisplayTrigger implements Parcelable {
    private static final String LOGTAG = "MmpAPI.DisplayTrigger";
    ...
    public DisplayTrigger(Parcel in) {
        ...
        try {
            ...
            MmpLog.e(LOGTAG, "Error parsing selector from display_trigger", e);
        }
    ...
    public boolean matchesEventDescription(ResultMessagesAnalatic.EventDescription eventDescription) {
            ...
            if (mEventName.equals(ANY_EVENT) ||
                ...
                if (mEvaluator != null) {
                    try {
                        ...
                        MmpLog.e(LOGTAG, "Error evaluating selector", e);
                        return false;
                    }
                } else {
                    return true;
