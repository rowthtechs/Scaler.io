...
/**
 * SQLite database adapter for MmpAPI.
 *
 ...
 *
 */
/* package */ class MmpDbAdapter {
    private static final String LOGTAG = "MmpAPI.Database";
    private static final Map<Context, MmpDbAdapter> sInstances = new HashMap<>();
    ...
    private static final String DATABASE_NAME = "mmp";
    ...
    private static class MPDatabaseHelper extends SQLiteOpenHelper {
        ...
        public void onCreate(SQLiteDatabase db) {
            MmpLog.v(LOGTAG, "Creating a new Mmp events DB");
        ...
        public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
            MmpLog.v(LOGTAG, "Upgrading app, replacing Mmp events DB");
            ...
            if (prefsDir.exists() && prefsDir.isDirectory()) {
                String[] storedPrefsFiles = prefsDir.list(new FilenameFilter() {
                    ...
                    public boolean accept(File dir, String name) {
                        return name.startsWith("com.mmp.android.mpmetrics.MmpAPI_");
                    }
                });
    ...
    public MmpDbAdapter(Context context) {
        this(context, DATABASE_NAME);
    }

    public MmpDbAdapter(Context context, String dbName) {
        mDb = new MPDatabaseHelper(context, dbName);
    }

    public static MmpDbAdapter getInstance(Context context) {
        synchronized (sInstances) {
            final Context appContext = context.getApplicationContext();
            MmpDbAdapter ret;
            if (! sInstances.containsKey(appContext)) {
                ret = new MmpDbAdapter(appContext);
    ...
    public int addJSON(JSONObject j, String token, Table table, boolean isAutomaticRecord) {
        ...
        if (!this.belowMemThreshold()) {
            MmpLog.e(LOGTAG, "There is not enough space left on the device to store Mmp data, so data was discarded");
        ...
        try {
            ...
            MmpLog.e(LOGTAG, "Could not add Mmp data to table");
            ...
            MmpLog.e(LOGTAG, "Out of memory when adding Mmp data to table");
        } finally {
            if (c != null) {
                c.close();
            }
    ...
    /* package */ int pushAnonymousUpdatesToPeopleDb(String token, String distinctId) {
        ...
        try {
            ...
            MmpLog.e(LOGTAG, "Could not push anonymous updates records from " + Table.ANONYMOUS_PEOPLE.getName() + ". Re-initializing database.", e);
    ...
    /* package */ int rewriteEventDataWithProperties(Map<String, String> properties, String token) {
        ...
        try {
            ...
            MmpLog.e(LOGTAG, "Could not re-write events history. Re-initializing database.", e);
    ...
    public void cleanupEvents(String last_id, Table table, String token, boolean includeAutomaticEvents) {
        ...
        try {
            ...
            MmpLog.e(LOGTAG, "Could not clean sent Mmp records from " + tableName + ". Re-initializing database.", e);
            ...
            MmpLog.e(LOGTAG, "Unknown exception. Could not clean sent Mmp records from " + tableName + ".Re-initializing database.", e);
            mDb.deleteDatabase();
        } finally {
            mDb.close();
        }
    ...
    public void cleanupEvents(long time, Table table) {
        ...
        try {
            ...
            MmpLog.e(LOGTAG, "Could not clean timed-out Mmp records from " + tableName + ". Re-initializing database.", e);
    ...
    private void cleanupAutomaticEvents(Table table, String token) {
        ...
        try {
            ...
            MmpLog.e(LOGTAG, "Could not clean automatic Mmp records from " + tableName + ". Re-initializing database.", e);
    ...
    /**
     * Returns the data string to send to Mmp and the maximum ID of the row that
    ...
    public String[] generateDataString(Table table, String token, boolean includeAutomaticEvents) {
        ...
        try {
            ...
            MmpLog.e(LOGTAG, "Could not pull records for Mmp out of database " + tableName + ". Waiting to send.", e);
