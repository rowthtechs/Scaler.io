 ...
 *          mMmp = MmpAPI.getInstance(this, "YOUR MIXPANEL API TOKEN");
 *          ...
 *      }
 *
...
public class MmpAPI {
     ...
     */
    public static final String VERSION = MmpConfig.VERSION;
    ...
    /* package */ static void trackPushNotificationEventFromIntent(Context context, Intent intent, String eventName, JSONObject additionalProperties) {
        if (intent.hasExtra("mp") && intent.hasExtra("mp_campaign_id") && intent.hasExtra("mp_message_id")) {
            ...
            MmpLog.e(LOG_MESSAGE_TAG, "Intent is missing Mmp notification metadata, not tracking event: \"" + eventName + "\"");
        }
    }
    ...
    /* package */ static void trackPushNotificationEvent(Context context, Integer campaignId, Integer messageId, String androidNotificationId, String mpPayloadStr, String eventName, JSONObject additionalProperties) {
        ...
        try {
            ...
            MmpLog.e(LOG_MESSAGE_TAG, "Exception parsing mp payload from intent extras, not tracking event: \"" + eventName + "\"", e);
            return;
        }

        String projectToken = mpPayload.optString("token");
        if (projectToken == null) {
            MmpLog.e(LOG_MESSAGE_TAG, "\"token\" not found in mp payload, not tracking event: \"" + eventName + "\"");
            return;
        }
        ...
        if (distinctId == null) {
            MmpLog.e(LOG_MESSAGE_TAG, "\"distinct_id\" not found in mp payload, not tracking event: \"" + eventName + "\"");
            return;
        }
        ...
        try {
            ...
            MmpLog.e(LOG_MESSAGE_TAG, "Error setting tracking JSON properties.", e);
        }

        MmpAPI instance = getInstanceFromMpPayload(context, mpPayloadStr);
        if (instance == null) {
            MmpLog.e(LOG_MESSAGE_TAG, "Got null instance, not tracking \"" + eventName + "\"");
        } else {
    ...
    MmpAPI(Context context, Future<SharedPreferences> referrerPreferences, String token, boolean optOutTrackingDefault, JSONObject superProperties) {
        this(context, referrerPreferences, token, MmpConfig.getInstance(context), optOutTrackingDefault, superProperties);
    }
     ...
     * Use MmpAPI.getInstance to get an instance.
     */
    MmpAPI(Context context, Future<SharedPreferences> referrerPreferences, String token, MmpConfig config, boolean optOutTrackingDefault, JSONObject superProperties) {
        mContext = context;
        mToken = token;
        ...
        deviceInfo.put("android_lib_version", MmpConfig.VERSION);
        ...
        try {
            ...
            MmpLog.e(LOG_MESSAGE_TAG, "Exception getting app version name", e);
        }
        ...
        mSelectMessages = constructDecideUpdates(token, mUpdatesListener, mUpdatesFromMmp);
        ...
        mSelectMessages.setDistinctId(decideId);

        final boolean dbExists = MmpDbAdapter.getInstance(mContext).getDatabaseFile().exists();

        registerMmpActivityLifecycleCallbacks();

        if (CheckConfigration.checkInstallReferrerConfiguration(sReferrerPrefs)) {
...
//                    mMessages.updateEventProperties(new ResultMessagesAnalatic.UpdateEventsPropertiesDescription(mToken, mPersistentIdentity.getReferrerProperties()));
                }
            });
        ...
        if (!mConfig.getDisableDecideChecker()) {
            mMessages.installDecideCheck(mSelectMessages);
        }
...
//                messageProps.put("lib_version", MmpConfig.VERSION);
//                messageProps.put("user_id", token);
//                final ResultMessagesAnalatic.EventDescription eventDescription =
//                        new ResultMessagesAnalatic.EventDescription(
//                                "Integration",
//                                messageProps,
//                                "null");
//                mMessages.eventsMessage(eventDescription);
//                mMessages.postToServer(new ResultMessagesAnalatic.FlushDescription("HswyUf4LoucPPsdBgOkl0X7giTTTKt", false));
//
...
//        }
    ...
    public static MmpAPI getInstance(Context context, String token, boolean optOutTrackingDefault, JSONObject superProperties) {
        ...
        synchronized (sInstanceMap) {
            ...
            if (null == sReferrerPrefs) {
                sReferrerPrefs = sPrefsLoader.loadPreferences(context, MmpConfig.REFERRER_PREFS_NAME, null);
            }
            ...
            if (null == instance && CheckConfigration.checkBasicConfiguration(appContext)) {
                ...
                if (CheckConfigration.checkPushNotificationConfiguration(appContext)) {
                    try {
                        MmpFCMMessagingService.init();
                    } catch (Exception e) {
                        MmpLog.e(LOG_MESSAGE_TAG, "Push notification could not be initialized", e);
                    }
                }
            }
    ...
    public void alias(String alias, String original) {
        ...
        if (alias.equals(original)) {
            MmpLog.w(LOG_MESSAGE_TAG, "Attempted to alias identical distinct_ids " + alias + ". Alias message will not be sent.");
            return;
        }
        try {
            ...
            MmpLog.e(LOG_MESSAGE_TAG, "Failed to alias", e);
        }
        flush();
    }
    ...
    private void identify(String distinctId, boolean markAsUserId) {
        if (hasOptedOutTracking()) return;
        if (distinctId == null) {
            MmpLog.e(LOG_MESSAGE_TAG, "Can't identify with null distinct_id.");
            return;
        }
        synchronized (mPersistentIdentity) {
            ...
            if (!distinctId.equals(currentEventsDistinctId)) {
                try {
                    ...
                    MmpLog.e(LOG_MESSAGE_TAG, "Could not track identify event");
                }
            }
        }
    }
    ...
    public void trackMap(String eventName, Map<String, Object> properties) {
        ...
        if (null == properties) {
            ...
            try {
                ...
                MmpLog.w(LOG_MESSAGE_TAG, "Can't have null keys in the properties of trackMap!");
            }
        }
    }
    ...
    public void flush() {
        if (hasOptedOutTracking()) return;
        mMessages.postToServer(new ResultMessagesAnalatic.FlushDescription(mToken));
    }
    ...
    public void registerSuperPropertiesMap(Map<String, Object> superProperties) {
        ...
        if (null == superProperties) {
            MmpLog.e(LOG_MESSAGE_TAG, "registerSuperPropertiesMap does not accept null properties");
            return;
        }
        ...
        try {
            ...
            MmpLog.w(LOG_MESSAGE_TAG, "Can't have null keys in the properties of registerSuperPropertiesMap");
        }
    }
    ...
    public void registerSuperPropertiesOnceMap(Map<String, Object> superProperties) {
        if (hasOptedOutTracking()) return;
        if (null == superProperties) {
            MmpLog.e(LOG_MESSAGE_TAG, "registerSuperPropertiesOnceMap does not accept null properties");
            return;
        }
        ...
        try {
            ...
            MmpLog.w(LOG_MESSAGE_TAG, "Can't have null keys in the properties of registerSuperPropertiesOnce!");
        }
    }
    ...
    public void setGroup(String groupKey, List<Object> groupIDs) {
        ...
        for (Object s : groupIDs) {
            if (s == null) {
                MmpLog.w(LOG_MESSAGE_TAG, "groupID must be non-null");
            } else {
                vals.put(s);
            }
        }
        ...
        try {
            ...
            MmpLog.w(LOG_MESSAGE_TAG, "groupKey must be non-null");
        }
    }
        ...
        updateSuperProperties(new SuperPropertyUpdate() {
            public JSONObject update(JSONObject in) {
                try {
                    ...
                    MmpLog.e(LOG_MESSAGE_TAG, "Failed to add groups superProperty", e);
                }
    ...
    public Group getGroup(String groupKey, Object groupID) {
        ...
        if (!(group.mGroupKey.equals(groupKey) && group.mGroupID.equals(groupID))) {
            ...
            MmpLog.i(LOG_MESSAGE_TAG, "groups map key collision " + mapKey);
            group = new GroupImpl(groupKey, groupID);
            mGroups.put(mapKey, group);
        }
    ...
    public void reset() {
        ...
        getAnalyticsMessages().clearAnonymousUpdatesMessage(new ResultMessagesAnalatic.MmpDescription(mToken));
    ...
    public void optOutTracking() {
        getAnalyticsMessages().emptyTrackingQueues(new ResultMessagesAnalatic.MmpDescription(mToken));
    ...
    /* package */ void registerMmpActivityLifecycleCallbacks() {
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            if (mContext.getApplicationContext() instanceof Application) {
                ...
                mMmpLifecycleCallbacks = new MmpLifecycleCallbacks(this, mConfig);
                app.registerActivityLifecycleCallbacks(mMmpLifecycleCallbacks);
            } else {
                MmpLog.i(LOG_MESSAGE_TAG, "Context is not an Application, Mmp will not automatically show in-app notifications or A/B test experiments. We won't be able to automatically flush on an app background.");
            }
        }
    }
    ...
    public boolean isAppInForeground() {
        if (android.os.Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            if (mMmpLifecycleCallbacks != null) {
                return mMmpLifecycleCallbacks.isInForeground();
            }
        } else {
            MmpLog.e(LOG_MESSAGE_TAG, "Your build version is below 14. This method will always return false.");
        }
        return false;
    }
    ...
    /* package */ ResultMessagesAnalatic getAnalyticsMessages() {
        return ResultMessagesAnalatic.getInstance(mContext);
    }

    /* package */ SelectMessages getDecideMessages() {
        return mSelectMessages;
    }
    ...
    /* package */ SelectMessages constructDecideUpdates(final String token, final SelectMessages.OnNewResultsListener listener, UpdatesFromMmp updatesFromMmp) {
        return new SelectMessages(mContext, token, listener, updatesFromMmp, mPersistentIdentity.getSeenCampaignIds());
    }

    /* package */ UpdatesListener constructUpdatesListener() {
        if (Build.VERSION.SDK_INT < MmpConfig.UI_FEATURES_MIN_API) {
            MmpLog.i(LOG_MESSAGE_TAG, "Notifications are not supported on this Android OS Version");
    ...
    /* package */ UpdatesFromMmp constructUpdatesFromMmp(final Context context, final String token) {
        if (Build.VERSION.SDK_INT < MmpConfig.UI_FEATURES_MIN_API) {
            MmpLog.i(LOG_MESSAGE_TAG, "SDK version is lower than " + MmpConfig.UI_FEATURES_MIN_API + ". Web Configuration, A/B Testing, and Dynamic Tweaks are disabled.");
            ...
            MmpLog.i(LOG_MESSAGE_TAG, "DisableViewCrawler is set to true. Web Configuration, A/B Testing, and Dynamic Tweaks are disabled.");
            return new NoOpUpdatesFromMmp(sSharedTweaks);
        } else {
    ...
    private class PeopleImpl implements People {
        ...
        public void identify(String distinctId) {
            ...
            synchronized (mPersistentIdentity) {
                ...
                mSelectMessages.setDistinctId(distinctId);
            }
            pushWaitingPeopleRecord(distinctId);
         }
        ...
        public void setMap(Map<String, Object> properties) {
            if (hasOptedOutTracking()) return;
            if (null == properties) {
                MmpLog.e(LOG_MESSAGE_TAG, "setMap does not accept null properties");
                return;
            }
            ...
            try {
                ...
                MmpLog.w(LOG_MESSAGE_TAG, "Can't have null keys in the properties of setMap!");
            }
        }
        ...
        public void set(JSONObject properties) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception setting people properties", e);
            }
        }
        ...
        public void set(String property, Object value) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "set", e);
            }
        }
        ...
        public void setOnceMap(Map<String, Object> properties) {
            if (hasOptedOutTracking()) return;
            if (null == properties) {
                MmpLog.e(LOG_MESSAGE_TAG, "setOnceMap does not accept null properties");
                return;
            }
            try {
                setOnce(new JSONObject(properties));
            } catch (NullPointerException e) {
                MmpLog.w(LOG_MESSAGE_TAG, "Can't have null keys in the properties setOnceMap!");
            }
        }
        ...
        public void setOnce(JSONObject properties) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception setting people properties");
            }
        }
        ...
        public void increment(Map<String, ? extends Number> properties) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception incrementing properties", e);
            }
        }
        ...
        public void merge(String property, JSONObject updates) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception merging a property", e);
            }
        }
        ...
        public void append(String name, Object value) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception appending a property", e);
            }
        }
        ...
        public void union(String name, JSONArray value) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception unioning a property");
            }
        }
        ...
        public void unset(String name) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception unsetting a property", e);
            }
        }

        @Override
        public InAppNotification getNotificationIfAvailable() {
            return mSelectMessages.getNotification(mConfig.getTestMode());
        }
        ...
        public void trackNotificationSeen(InAppNotification notif) {
            ...
            if (people != null) {
                ...
                try {
                    ...
                    MmpLog.e(LOG_MESSAGE_TAG, "Exception trying to track an in-app notification seen", e);
                }
                people.append("campaigns", notif.getId());
                people.append("notifications", notifProperties);
            } else {
                MmpLog.e(LOG_MESSAGE_TAG, "No identity found. Make sure to call getPeople().identify() before showing in-app notifications.");
            }
        }
        ...
        @Override
        public void showNotificationById(int id, final Activity parent) {
            final InAppNotification notif = mSelectMessages.getNotification(id, mConfig.getTestMode());
        ...
        public void trackNotification(final String eventName, final InAppNotification notif, final JSONObject properties) {
            ...
            if (properties != null) {
                try {
                    ...
                    MmpLog.e(LOG_MESSAGE_TAG, "Exception merging provided properties with notification properties", e);
                }
            }
        ...
        @Override
        public void joinExperimentIfAvailable() {
            final JSONArray variants = mSelectMessages.getVariants();
        ...
        public void trackCharge(double amount, JSONObject properties) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception creating new charge", e);
            }
        }
        ...
        public void deleteUser() {
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception deleting a user");
            }
        }
        ...
        public void setPushRegistrationId(String registrationId) {
            synchronized (mPersistentIdentity) {
                MmpLog.d(LOG_MESSAGE_TAG, "Setting push token on people profile: " + registrationId);
        ...
        private void showGivenOrAvailableNotification(final InAppNotification notifOrNull, final Activity parent) {
            if (Build.VERSION.SDK_INT < MmpConfig.UI_FEATURES_MIN_API) {
                MmpLog.v(LOG_MESSAGE_TAG, "Will not show notifications, os version is too low.");
                return;
            }

            parent.runOnUiThread(new Runnable() {
                @Override
                @TargetApi(MmpConfig.UI_FEATURES_MIN_API)
                public void run() {
                    final ReentrantLock lock = UpdateDisplayState.getLockObject();
                    lock.lock();
                    try {
                        if (UpdateDisplayState.hasCurrentProposal()) {
                            MmpLog.v(LOG_MESSAGE_TAG, "DisplayState is locked, will not show notifications.");
                        ...
                        if (null == toShow) {
                            MmpLog.v(LOG_MESSAGE_TAG, "No notification available, will not show.");
                            return; // Nothing to show
                        }

                        final InAppNotification.Type inAppType = toShow.getType();
                        if (inAppType == InAppNotification.Type.TAKEOVER && !CheckConfigration.checkTakeoverInAppActivityAvailable(parent.getApplicationContext())) {
                            MmpLog.v(LOG_MESSAGE_TAG, "Application is not configured to show takeover notifications, none will be shown.");
                        ...
                        if (intentId <= 0) {
                            MmpLog.e(LOG_MESSAGE_TAG, "DisplayState Lock in inconsistent state! Please report this issue to Mmp");
                            return;
                        }
                        ...
                        switch (inAppType) {
                            case MINI: {
                                ...
                                if (null == claimed) {
                                    MmpLog.v(LOG_MESSAGE_TAG, "Notification's display proposal was already consumed, no notification will be shown.");
                                ...
                                MmpLog.v(LOG_MESSAGE_TAG, "Attempting to show mini notification.");
                                ...
                                try {
                                    ...
                                    MmpLog.v(LOG_MESSAGE_TAG, "Unable to show notification.");
                                    mSelectMessages.markNotificationAsUnseen(toShow);
                                }
                            }
                            break;
                            case TAKEOVER: {
                                MmpLog.v(LOG_MESSAGE_TAG, "Sending intent for takeover notification.");
                            ...
                            break;
                            default:
                                MmpLog.e(LOG_MESSAGE_TAG, "Unrecognized notification type " + inAppType + " can't be shown");
                        }
    ...
    private interface UpdatesListener extends SelectMessages.OnNewResultsListener {
        public void addOnMmpUpdatesReceivedListener(OnMmpUpdatesReceivedListener listener);
        public void removeOnMmpUpdatesReceivedListener(OnMmpUpdatesReceivedListener listener);
    }
    ...
    private class GroupImpl implements Group {
        ...
        public void set(JSONObject properties) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception setting group properties", e);
            }
        }
        ...
        public void setOnceMap(Map<String, Object> properties) {
            ...
            try {
                ...
                MmpLog.w(LOG_MESSAGE_TAG, "Can't have null keys in the properties for setOnceMap!");
            }
        }
        ...
        public void setOnce(JSONObject properties) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception setting group properties");
            }
        }
        ...
        public void setOnce(String property, Object value) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Property name cannot be null", e);
            }
        }
        ...
        public void union(String name, JSONArray value) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception unioning a property", e);
            }
        }
        ...
        public void remove(String name, Object value) {
            ...
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception removing a property", e);
            }
        }
        ...
        public void deleteGroup() {
            try {
                ...
                MmpLog.e(LOG_MESSAGE_TAG, "Exception deleting a group", e);
            }
        }
    ...
    private class SupportedUpdatesListener implements UpdatesListener, Runnable {
        ...
        public void addOnMmpUpdatesReceivedListener(OnMmpUpdatesReceivedListener listener) {
            ...
            if (mSelectMessages.hasUpdatesAvailable()) {
                onNewResults();
            }
        }
        ...
        public void run() {
            ...
            mConnectIntegrations.setupIntegrations(mSelectMessages.getIntegrations());
        }
    ...
    protected void flushNoDecideCheck() {
        if (hasOptedOutTracking()) return;
        mMessages.postToServer(new ResultMessagesAnalatic.FlushDescription(mToken, false));
    }

    protected void track(String eventName, JSONObject properties, boolean isAutomaticEvent) {
        if (hasOptedOutTracking() || (isAutomaticEvent && !mSelectMessages.shouldTrackAutomaticEvent())) {
            return;
        }
        ...
        try {
            ...
            final ResultMessagesAnalatic.EventDescription eventDescription =
                    new ResultMessagesAnalatic.EventDescription(eventName, messageProps,
                            mToken, isAutomaticEvent, mSessionMetadata.getMetadataForEvent());
            mMessages.eventsMessage(eventDescription);

            if (mMmpLifecycleCallbacks.getCurrentActivity() != null) {
                getPeople().showGivenNotification(mSelectMessages.getNotification(eventDescription, mConfig.getTestMode()), mMmpLifecycleCallbacks.getCurrentActivity());
            }
            ...
            MmpLog.e(LOG_MESSAGE_TAG, "Exception tracking event " + eventName, e);
        }
    }

    private void recordPeopleMessage(JSONObject message) {
        if (hasOptedOutTracking()) return;
        mMessages.peopleMessage(new ResultMessagesAnalatic.PeopleDescription(message, mToken));
    }

    private void recordGroupMessage(JSONObject message) {
        if (hasOptedOutTracking()) return;
        if (message.has("group_key") && message.has("group_id")) {
            mMessages.groupMessage(new ResultMessagesAnalatic.GroupDescription(message, mToken));
        } else {
            MmpLog.e(LOG_MESSAGE_TAG, "Attempt to update group without key and value--this should not happen.");
        }
    }

    private void pushWaitingPeopleRecord(String distinctId) {
        mMessages.pushAnonymousPeopleMessage(new ResultMessagesAnalatic.PushAnonymousPeopleDescription(distinctId, mToken));
    }
    ...
    private static void registerAppLinksListeners(Context context, final MmpAPI mmp) {
        ...
        try {
                    ...
                    if (args != null) {
                        for (final String key : args.keySet()) {
                            try {
                                ...
                                MmpLog.e(LOG_TAG_APP_LINKS, "failed to add key \"" + key + "\" to properties for tracking bolts event", e);
                            }
                        }
                    }
            ...
            MmpLog.d(LOG_TAG_APP_LINKS, "Failed to invoke LocalBroadcastManager.registerReceiver() -- App Links tracking will not be enabled due to this exception", e);
        } catch (final ClassNotFoundException e) {
            MmpLog.d(LOG_TAG_APP_LINKS, "To enable App Links tracking, add implementation 'androidx.localbroadcastmanager:localbroadcastmanager:1.0.0': " + e.getMessage());
        } catch (final NoSuchMethodException e) {
            MmpLog.d(LOG_TAG_APP_LINKS, "To enable App Links tracking, add implementation 'androidx.localbroadcastmanager:localbroadcastmanager:1.0.0': " + e.getMessage());
        } catch (final IllegalAccessException e) {
            MmpLog.d(LOG_TAG_APP_LINKS, "App Links tracking will not be enabled due to this exception: " + e.getMessage());
        }
    }
    ...
    private static void checkIntentForInboundAppLink(Context context) {
        ...
        if (context instanceof Activity) {
            try {
                ...
                MmpLog.d(LOG_TAG_APP_LINKS, "Failed to invoke bolts.AppLinks.getTargetUrlFromInboundIntent() -- Unable to detect inbound App Links", e);
            } catch (final ClassNotFoundException e) {
                MmpLog.d(LOG_TAG_APP_LINKS, "Please install the Bolts library >= 1.1.2 to track App Links: " + e.getMessage());
            } catch (final NoSuchMethodException e) {
                MmpLog.d(LOG_TAG_APP_LINKS, "Please install the Bolts library >= 1.1.2 to track App Links: " + e.getMessage());
            } catch (final IllegalAccessException e) {
                MmpLog.d(LOG_TAG_APP_LINKS, "Unable to detect inbound App Links: " + e.getMessage());
            }
        } else {
            MmpLog.d(LOG_TAG_APP_LINKS, "Context is not an instance of Activity. To detect inbound App Links, pass an instance of an Activity to getInstance.");
        }
    }
    ...
    private final ResultMessagesAnalatic mMessages;
    private final MmpConfig mConfig;
    ...
    private final SelectMessages mSelectMessages;
    private final Map<String, String> mDeviceInfo;
    private final Map<String, Long> mEventTimings;
    private MmpLifecycleCallbacks mMmpLifecycleCallbacks;
    ...
    private static final String LOG_MESSAGE_TAG = "MmpAPI.API";
    private static final String LOG_TAG_APP_LINKS = "MmpAPI.AL";
