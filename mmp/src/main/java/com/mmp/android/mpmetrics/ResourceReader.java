...
/**
 * This class is for internal use in the Mmp library, and should not be imported into
 * client code.
 */
public abstract class ResourceReader implements ResourceIds {
                ...
                if (Modifier.isStatic(modifiers)) {
                    ...
                    if (fieldType == int.class) {
                        try {
                            ...
                            // https://github.com/mmp/mmp-android/issues/241
                            MmpLog.e(LOGTAG, "Can't read built-in id name from " + platformIdClass.getName(), e);
                        }
                    }
                }
            }
        } catch (IllegalAccessException e) {
            MmpLog.e(LOGTAG, "Can't read built-in id names from " + platformIdClass.getName(), e);
        }
    }
    ...
    protected void initialize() {
        ...
        try {
            ...
            MmpLog.w(LOGTAG, "Can't load names for Android view ids from '" + localClassName + "', ids by name will not be available in the events editor.");
            MmpLog.i(LOGTAG,
                    "You may be missing a Resources class for your package due to your proguard configuration, " +
                            ...
                            "you can add the following to your AndroidManifest.xml file to explicitly point the Mmp library to " +
                            "the appropriate library for your resources class:\n\n" +
                            "<meta-data android:name=\"com.mmp.android.MPConfig.ResourcePackageName\" android:value=\"YOUR_PACKAGE_NAME\" />\n\n" +
    ...
    private static final String LOGTAG = "MmpAPI.RsrcReader";
}
