...
/**
 * Represents a takeover in-app notification delivered from Mmp. Under ordinary circumstances,
 * most code won't have to interact with this class directly, but rather will display
 * InAppNotifications using {@link com.mmp.android.mpmetrics.MmpAPI.People#showNotificationIfAvailable(Activity)}
 */
