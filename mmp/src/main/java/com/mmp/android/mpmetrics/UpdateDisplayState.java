...
public class UpdateDisplayState implements Parcelable {
    ...
    /**
     * This class is intended for internal use by the Mmp library.
    ...
    public static abstract class DisplayState implements Parcelable {
        ...
        public static final class InAppNotificationState extends DisplayState {
            ...
            private static String INAPP_KEY = "com.com.mmp.android.mpmetrics.UpdateDisplayState.InAppNotificationState.INAPP_KEY";
            private static String HIGHLIGHT_KEY = "com.com.mmp.android.mpmetrics.UpdateDisplayState.InAppNotificationState.HIGHLIGHT_KEY";
        }
        ...
        public static final String STATE_TYPE_KEY = "com.mmp.android.mpmetrics.UpdateDisplayState.DisplayState.STATE_TYPE_KEY";
        public static final String STATE_IMPL_KEY = "com.mmp.android.mpmetrics.UpdateDisplayState.DisplayState.STATE_IMPL_KEY";
    }
    ...
    /* package */ static boolean hasCurrentProposal() {
        ...
        if (sNextIntentId > 0 && deltaTime > MAX_LOCK_TIME_MILLIS) {
            MmpLog.i(LOGTAG, "UpdateDisplayState set long, long ago, without showing. Update state will be cleared.");
    ...
    /* package */ static int proposeDisplay(final DisplayState state, final String distinctId, final String token) {
        ...
        if (! hasCurrentProposal()) {
            ...
            MmpLog.v(LOGTAG, "Already showing (or cooking) a Mmp update, declining to show another.");
        }
    ...
    private static final String LOGTAG = "MmpAPI.UpDisplSt";
    private static final long MAX_LOCK_TIME_MILLIS = 12 * 60 * 60 * 1000; // Twelve hour timeout on inApp activities

    private static final String DISTINCT_ID_BUNDLE_KEY = "com.mmp.android.mpmetrics.UpdateDisplayState.DISTINCT_ID_BUNDLE_KEY";
    private static final String TOKEN_BUNDLE_KEY = "com.mmp.android.mpmetrics.UpdateDisplayState.TOKEN_BUNDLE_KEY";
    private static final String DISPLAYSTATE_BUNDLE_KEY = "com.mmp.android.mpmetrics.UpdateDisplayState.DISPLAYSTATE_BUNDLE_KEY";
