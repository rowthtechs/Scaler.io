 ...
 * first and second objects are never null. However, Mmp relies on the fist object to
 * be null to apply wildcard changes.
 */
public class MmpPair<F, S> extends Pair<F, S> {

    public MmpPair(F first, S second) {
        super(first, second);
    }
