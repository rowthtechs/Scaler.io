...
/* package */ class Caller {
    ...
    public Object applyMethodWithArguments(View target, Object[] arguments) {
        ...
        if (mTargetClass.isAssignableFrom(klass)) {
            try {
                ...
                MmpLog.e(LOGTAG, "Method " + mTargetMethod.getName() + " appears not to be public", e);
            } catch (final IllegalArgumentException e) {
                MmpLog.e(LOGTAG, "Method " + mTargetMethod.getName() + " called with arguments of the wrong type", e);
            } catch (final InvocationTargetException e) {
                MmpLog.e(LOGTAG, "Method " + mTargetMethod.getName() + " threw an exception", e);
            }
        }
    ...
    private static final String LOGTAG = "MmpABTest.Caller";
}
