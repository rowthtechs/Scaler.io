...
/* package */ class EditProtocol {
    ...
    public ViewVisitor readEventBinding(JSONObject source, ViewVisitor.OnEventListener listener) throws BadInstructionsException {
        try {
            ...
            if ("click".equals(eventType)) {
                ...
                throw new BadInstructionsException("Mmp can't track event type \"" + eventType + "\"");
            }
            ...
            if (source.getString("change_type").equals("property")) {
                ...
                for (int i = 0; i < length; i++) {
                    ...
                    if (view_id == null || anchor_id == null) {
                        MmpLog.w(LOGTAG, "View (" + view_id_name + ") or anchor (" + anchor_id_name + ") not found.");
                        continue;
                    }
    ...
    public MmpPair<String, Object> readTweak(JSONObject tweakDesc) throws BadInstructionsException {
        try {
            ...
            return new MmpPair<String, Object>(tweakName, value);
        } catch (JSONException e) {
    ...
    /* package */ List<Pathfinder.PathElement> readPath(JSONArray pathDesc, ResourceIds idNameToId) throws JSONException {
        ...
        for (int i = 0; i < pathDesc.length(); i++) {
            ...
            if ("shortest".equals(prefixCode)) {
                ...
                MmpLog.w(LOGTAG, "Unrecognized prefix type \"" + prefixCode + "\". No views will be matched");
    ...
    private Integer reconcileIds(int explicitId, String idName, ResourceIds idNameToId) {
        ...
        if (-1 != idFromName && -1 != explicitId && idFromName != explicitId) {
            MmpLog.e(LOGTAG, "Path contains both a named and an explicit id, and they don't match. No views will be matched.");
            return null;
        }
    ...
    private static final String LOGTAG = "MmpAPI.EProtocol";
} // EditProtocol
