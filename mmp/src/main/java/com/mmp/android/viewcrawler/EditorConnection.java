...
import com.mmp.android.websocket.client.WebSocketClient;
...
/* package */ class EditorConnection {
    ...
    private class EditorClient extends WebSocketClient {
        ...
        public void onOpen(ServerHandshake handshakedata) {
            MmpLog.v(LOGTAG, "Websocket connected");
        }

        @Override
        public void onMessage(String message) {
            MmpLog.v(LOGTAG, "Received message from editor:\n" + message);
            try {
                ...
                MmpLog.e(LOGTAG, "Bad JSON received:" + message, e);
            }
        }

        @Override
        public void onClose(int code, String reason, boolean remote) {
            MmpLog.v(LOGTAG, "WebSocket closed. Code: " + code + ", reason: " + reason + "\nURI: " + mURI);
            mService.cleanup();
        }
        ...
        public void onError(Exception ex) {
            if (ex != null && ex.getMessage() != null) {
                MmpLog.e(LOGTAG, "Websocket Error: " + ex.getMessage());
            } else {
                MmpLog.e(LOGTAG, "Unknown websocket error occurred");
            }
        }
    }
    ...
    private static final String LOGTAG = "MmpAPI.EditorCnctn";
}
