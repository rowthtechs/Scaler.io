...
/* package */ class Pathfinder {
     ...
     * So
     *
     *     E.viewClassName == 'com.mmp.Awesome' => V instanceof com.mmpAwesome
    ...
    public void findTargetsInRoot(View givenRootView, List<PathElement> path, Accumulator accumulator) {
        ...
        if (mIndexStack.full()) {
            MmpLog.w(LOGTAG, "There appears to be a concurrency issue in the pathfinding code. Path will not be matched.");
    ...
    private void findTargetsInMatchedView(View alreadyMatched, List<PathElement> remainingPath, Accumulator accumulator) {
        ...
        if (mIndexStack.full()) {
            MmpLog.v(LOGTAG, "Path is too deep, will not match");
    ...
    private static final String LOGTAG = "MmpAPI.PathFinder";
}
