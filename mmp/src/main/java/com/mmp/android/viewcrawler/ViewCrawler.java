...
import com.mmp.android.mpmetrics.MmpConfig;
import com.mmp.android.mpmetrics.MmpAPI;
import com.mmp.android.mpmetrics.OnMmpTweaksUpdatedListener;
import com.mmp.android.mpmetrics.ResourceIds;
import com.mmp.android.mpmetrics.ResourceReader;
import com.mmp.android.mpmetrics.SuperPropertyUpdate;
...
import com.mmp.android.util.MmpPair;
...
/**
 * This class is for internal use by the Mmp API, and should
 * not be called directly by your code.
 */
@TargetApi(MmpConfig.UI_FEATURES_MIN_API)
public class ViewCrawler implements UpdatesFromMmp, TrackingDebug, ViewVisitor.OnLayoutErrorListener {

    public ViewCrawler(Context context, String token, MmpAPI mmp, Tweaks tweaks) {
        mConfig = MmpConfig.getInstance(context);

        mContext = context;
        mEditState = new EditState();
        mTweaks = tweaks;
        mDeviceInfo = mmp.getDeviceInfo();
        mScaledDensity = Resources.getSystem().getDisplayMetrics().scaledDensity;
        mTweaksUpdatedListeners = Collections.newSetFromMap(new ConcurrentHashMap<OnMmpTweaksUpdatedListener, Boolean>());
        ...
        mDynamicEventTracker = new DynamicEventTracker(mmp, mMessageThreadHandler);
        mMmp = mmp;
    ...
    private class ViewCrawlerHandler extends Handler {
        ...
        public ViewCrawlerHandler(Context context, String token, Looper looper, ViewVisitor.OnLayoutErrorListener layoutErrorListener) {
            ...
            mOriginalEventBindings = new HashSet<MmpPair<String, JSONObject>>();
            mEditorChanges = new HashMap<String, MmpPair<String, JSONObject>>();
            mEditorTweaks = new HashMap<String, MmpPair<String, Object>>();
            mEditorAssetUrls = new ArrayList<String>();
            mEditorEventBindings = new HashMap<String, MmpPair<String, JSONObject>>();
            mAppliedVisualChanges = new HashSet<VariantChange>();
            mAppliedTweaks = new HashSet<VariantTweak>();
            mEmptyExperiments = new HashSet<MmpPair<Integer, Integer>>();
            mPersistentEventBindings = new HashSet<MmpPair<String, JSONObject>>();
            mSeenExperiments = new HashSet<MmpPair<Integer, Integer>>();
            ...
            if (null != variants) {
                try {
                    ...
                    for (int variantIx = 0; variantIx < variantsLength; variantIx++) {
                        ...
                        final MmpPair<Integer, Integer> variantId = new MmpPair<Integer, Integer>(experimentIdPart, variantIdPart);
                    ...
                    MmpLog.i(LOGTAG, "JSON error when loading ab tests / tweaks, clearing persistent memory", e);
                    final SharedPreferences preferences = getSharedPreferences();
                    final SharedPreferences.Editor editor = preferences.edit();
            ...
            if (null != eventBindings) {
                try {
                    ...
                    for (int i = 0; i < bindings.length(); i++) {
                        ...
                        mPersistentEventBindings.add(new MmpPair<String, JSONObject>(targetActivity, event));
                    }
                } catch (final JSONException e) {
                    MmpLog.i(LOGTAG, "JSON error when loading event bindings, clearing persistent memory", e);
                    final SharedPreferences preferences = getSharedPreferences();
                    final SharedPreferences.Editor editor = preferences.edit();
        ...
        private void connectToEditor() {
            MmpLog.v(LOGTAG, "connecting to editor");
            if (mEditorConnection != null && mEditorConnection.isValid()) {
                MmpLog.v(LOGTAG, "There is already a valid connection to an events editor.");
                return;
            }

            final SSLSocketFactory socketFactory = mConfig.getSSLSocketFactory();
            if (null == socketFactory) {
                MmpLog.v(LOGTAG, "SSL is not available on this device, no connection will be attempted to the events editor.");
                return;
            }

            final String url = MmpConfig.getInstance(mContext).getEditorUrl() + mToken;
            try {
                ...
                MmpLog.e(LOGTAG, "Error parsing URI " + url + " for editor websocket", e);
            } catch (final EditorConnection.EditorConnectionException e) {
                MmpLog.e(LOGTAG, "Error connecting to URI " + url, e);
            } catch (final IOException e) {
                MmpLog.i(LOGTAG, "Can't create SSL Socket to connect to editor service", e);
            }
        }
        ...
        private void sendError(String errorMessage) {
            ...
            try {
                ...
                MmpLog.e(LOGTAG, "Apparently impossible JSONException", e);
            }
            ...
            try {
                ...
                MmpLog.e(LOGTAG, "Can't write error message to editor", e);
            } finally {
                try {
                    writer.close();
                } catch (final IOException e) {
                    MmpLog.e(LOGTAG, "Could not close output writer to editor", e);
                }
            }
        }
        ...
        private void sendDeviceInfo() {
            ...
            try {
                    ...
                    for (Map.Entry<String, Tweaks.TweakValue> tweak:tweakDescs.entrySet()) {
                        ...
                        switch (desc.type) {
                            ...
                            case Tweaks.STRING_TYPE:
                                ...
                                break;
                            default:
                                MmpLog.wtf(LOGTAG, "Unrecognized Tweak Type " + desc.type + " encountered.");
                        }
                        j.endObject();
                    }
                    j.endArray();
                ...
                MmpLog.e(LOGTAG, "Can't write device_info to server", e);
            } finally {
                try {
                    j.close();
                } catch (final IOException e) {
                    MmpLog.e(LOGTAG, "Can't close websocket writer", e);
                }
            }
        }
        ...
        private void sendSnapshot(JSONObject message) {
            ...
            try {
                ...
                if (payload.has("config")) {
                    ...
                    MmpLog.v(LOGTAG, "Initializing snapshot with configuration");
                }
            } catch (final JSONException e) {
                MmpLog.e(LOGTAG, "Payload with snapshot config required with snapshot request", e);
                sendError("Payload with snapshot config required with snapshot request");
                return;
            } catch (final EditProtocol.BadInstructionsException e) {
                MmpLog.e(LOGTAG, "Editor sent malformed message with snapshot request", e);
            ...
            if (null == mSnapshot) {
                ...
                MmpLog.w(LOGTAG, "Mmp editor is misconfigured, sent a snapshot request without a valid configuration.");
                return;
            }
            ...
            try {
                ...
                MmpLog.e(LOGTAG, "Can't write snapshot request to server", e);
            } finally {
                try {
                    writer.close();
                } catch (final IOException e) {
                    MmpLog.e(LOGTAG, "Can't close writer.", e);
                }
            }
        }
        ...
        private void sendReportTrackToEditor(String eventName) {
            ...
            try {
                ...
                MmpLog.e(LOGTAG, "Can't write track_message to server", e);
            } finally {
                try {
                    j.close();
                } catch (final IOException e) {
        ...
        private void handleEditorChangeReceived(JSONObject changeMessage) {
            try {
                ...
                for (int i = 0; i < actions.length(); i++) {
                    ...
                    final String targetActivity = JSONUtils.optionalStringKey(change, "target_activity");
                    final String name = change.getString("name");
                    mEditorChanges.put(name, new MmpPair<String, JSONObject>(targetActivity, change));
                }

                applyVariantsAndEventBindings();
            } catch (final JSONException e) {
                MmpLog.e(LOGTAG, "Bad change request received", e);
            }
        }
        ...
        private void handleEditorBindingsCleared(JSONObject clearMessage) {
            try {
                ...
                MmpLog.e(LOGTAG, "Bad clear request received", e);
            }
        ...
        private void handleEditorTweaksReceived(JSONObject tweaksMessage) {
            try {
                ...
                for (int i = 0; i < length; i++) {
                    final JSONObject tweakDesc = tweaks.getJSONObject(i);
                    MmpPair<String, Object> tweak = mProtocol.readTweak(tweakDesc);
                    mEditorTweaks.put(tweak.first, tweak);
                }
            } catch (final JSONException e) {
                MmpLog.e(LOGTAG, "Bad tweaks received", e);
            } catch (final EditProtocol.BadInstructionsException e) {
                MmpLog.e(LOGTAG, "Bad tweaks received", e);
            }
        ...
        private void handleEditorBindingsReceived(JSONObject message) {
            ...
            try {
                ...
                MmpLog.e(LOGTAG, "Bad event bindings received", e);
                return;
            }
            ...
            if (!mPersistentEventBindings.isEmpty() && mOriginalEventBindings.isEmpty()) {
                ...
                for (MmpPair<String, JSONObject> eventBinding : mPersistentEventBindings) {
                    try {
            ...
            for (int i = 0; i < eventCount; i++) {
                try {
                    ...
                    final String targetActivity = JSONUtils.optionalStringKey(event, "target_activity");
                    mEditorEventBindings.put(event.get("path").toString(), new MmpPair<String, JSONObject>(targetActivity, event));
                } catch (final JSONException e) {
                    MmpLog.e(LOGTAG, "Bad event binding received from editor in " + eventBindings.toString(), e);
                }
            }
        ...
        private void handleEditorClosed() {
            ...
            MmpLog.v(LOGTAG, "Editor closed- freeing snapshot");
        ...
        private void applyVariantsAndEventBindings() {
            final List<MmpPair<String, ViewVisitor>> newVisitors = new ArrayList<MmpPair<String, ViewVisitor>>();
            final Set<MmpPair<Integer, Integer>> toTrack = new HashSet<MmpPair<Integer, Integer>>();
...

            {
                for (VariantChange changeInfo : mAppliedVisualChanges) {
                    try {
                        ...
                        newVisitors.add(new MmpPair<String, ViewVisitor>(changeInfo.activityName, edit.visitor));
                        ...
                        MmpLog.v(LOGTAG, "Can't load assets for an edit, won't apply the change now", e);
                    } catch (final EditProtocol.InapplicableInstructionsException e) {
                        MmpLog.i(LOGTAG, e.getMessage());
                    } catch (final EditProtocol.BadInstructionsException e) {
                        MmpLog.e(LOGTAG, "Bad persistent change request cannot be applied.", e);
                    }
                }
            }

            {
                for (VariantTweak tweakInfo : mAppliedTweaks) {
                    try {
                        final MmpPair<String, Object> tweakValue = mProtocol.readTweak(tweakInfo.tweak);
                        ...
                        MmpLog.e(LOGTAG, "Bad editor tweak cannot be applied.", e);
                    }
                }
            ...
            {
                for (MmpPair<String, JSONObject> changeInfo : mEditorChanges.values()) {
                    try {
                        final EditProtocol.Edit edit = mProtocol.readEdit(changeInfo.second);
                        newVisitors.add(new MmpPair<String, ViewVisitor>(changeInfo.first, edit.visitor));
                        ...
                        MmpLog.e(LOGTAG, "Bad editor change request cannot be applied.", e);
                    }
                }
            }

            {
                for (MmpPair<String, Object> tweak : mEditorTweaks.values()) {
...

            {
                if (mEditorEventBindings.size() == 0 && mOriginalEventBindings.size() == 0) {
                    for (MmpPair<String, JSONObject> changeInfo : mPersistentEventBindings) {
                        try {
                            final ViewVisitor visitor = mProtocol.readEventBinding(changeInfo.second, mDynamicEventTracker);
                            newVisitors.add(new MmpPair<String, ViewVisitor>(changeInfo.first, visitor));
                        } catch (final EditProtocol.InapplicableInstructionsException e) {
                            MmpLog.i(LOGTAG, e.getMessage());
                        } catch (final EditProtocol.BadInstructionsException e) {
                            MmpLog.e(LOGTAG, "Bad persistent event binding cannot be applied.", e);
                        }
                    }
                }
            }
            ...
            {
                for (MmpPair<String, JSONObject> changeInfo : mEditorEventBindings.values()) {
                    try {
                        final ViewVisitor visitor = mProtocol.readEventBinding(changeInfo.second, mDynamicEventTracker);
                        newVisitors.add(new MmpPair<String, ViewVisitor>(changeInfo.first, visitor));
                    } catch (final EditProtocol.InapplicableInstructionsException e) {
                        ...
                        MmpLog.e(LOGTAG, "Bad editor event binding cannot be applied.", e);
                    }
                }
            }
            ...
            for (int i = 0; i < totalEdits; i++) {
                final MmpPair<String, ViewVisitor> next = newVisitors.get(i);
            ...
            for (MmpPair<Integer, Integer> emptyExperiment : mEmptyExperiments) {
            ...
            if (updatedTweaks.size() > 0) {
                for (OnMmpTweaksUpdatedListener listener : mTweaksUpdatedListeners) {
                    listener.onMmpTweakUpdated(updatedTweaks);
                }
            }
        }

        private void trackSeenExperiments(Set<MmpPair<Integer, Integer>> toTrack) {
            if (toTrack != null && toTrack.size() > 0) {
                final JSONObject variantObject = new JSONObject();

                try {
                    for (MmpPair<Integer, Integer> variant : toTrack) {
                        ...
                        mMmp.getPeople().merge("$experiments", variantObject);
                        mMmp.updateSuperProperties(new SuperPropertyUpdate() {
                            public JSONObject update(JSONObject in) {
                                try {
                                    in.put("$experiments", variantObject);
                                } catch (JSONException e) {
                                    MmpLog.wtf(LOGTAG, "Can't write $experiments super property", e);
                                }
                                return in;
                            }
                        });

                        mMmp.track("$experiment_started", trackProps);
                    }
                } catch (JSONException e) {
                    MmpLog.wtf(LOGTAG, "Could not build JSON for reporting experiment start", e);
                }
            }
        }
        ...
        private final Map<String, MmpPair<String,JSONObject>> mEditorChanges;
        private final Map<String, MmpPair<String, Object>> mEditorTweaks;
        private final List<String> mEditorAssetUrls;
        private final Map<String, MmpPair<String,JSONObject>> mEditorEventBindings;
        private final Set<VariantChange> mAppliedVisualChanges;
        private final Set<VariantTweak> mAppliedTweaks;
        private final Set<MmpPair<Integer, Integer>> mEmptyExperiments;
        private final Set<MmpPair<String,JSONObject>> mPersistentEventBindings;
        private final Set<MmpPair<String,JSONObject>> mOriginalEventBindings;
        private final Set<MmpPair<Integer, Integer>> mSeenExperiments;
    }
    ...
    private static class VariantChange {
        public VariantChange(String aName, String anActivityName, JSONObject someChange, MmpPair<Integer, Integer> aVariantId) {
            name = aName;
        ...
        public final MmpPair<Integer, Integer> variantId;
    }

    private static class VariantTweak {
        public VariantTweak(String aTweakName, JSONObject aTweak, MmpPair<Integer, Integer> aVariantId) {
    ...
    private final Set<OnMmpTweaksUpdatedListener> mTweaksUpdatedListeners;

    private static final String SHARED_PREF_EDITS_FILE = "mmp.viewcrawler.changes";
    private static final String SHARED_PREF_CHANGES_KEY = "mmp.viewcrawler.changes";
    private static final String SHARED_PREF_BINDINGS_KEY = "mmp.viewcrawler.bindings";
    ...
    private static final String LOGTAG = "MmpAPI.ViewCrawler";
}
